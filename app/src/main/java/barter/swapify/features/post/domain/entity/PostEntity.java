package barter.swapify.features.post.domain.entity;
...
public class PostEntity {
    ...
    public PostEntity(String key, String userId, String avatar, String fullName, String title, String description, String fileName, String imageUrl) {
        this.key = key;
        this.userId = userId;
        this.avatar = avatar;
